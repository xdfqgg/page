...
// 20 块碎片：clip-path 全面覆盖 120x120 圆形区域
const FRAGMENTS = [
  { clip: "polygon(0 0, 30% 0, 20% 15%, 0 20%)", hover: { x: -4, y: -4 } },
  { clip: "polygon(30% 0, 60% 0, 50% 18%, 20% 15%)", hover: { x: 0, y: -5 } },
  { clip: "polygon(60% 0, 100% 0, 100% 18%, 80% 22%, 50% 18%)", hover: { x: 4, y: -4 } },
  { clip: "polygon(100% 18%, 100% 42%, 85% 38%, 80% 22%)", hover: { x: 6, y: -1 } },
  { clip: "polygon(100% 42%, 100% 65%, 88% 58%, 85% 38%)", hover: { x: 7, y: 2 } },
  { clip: "polygon(100% 65%, 100% 88%, 82% 80%, 88% 58%)", hover: { x: 5, y: 5 } },
  { clip: "polygon(82% 80%, 100% 88%, 100% 100%, 70% 100%, 60% 85%)", hover: { x: 3, y: 7 } },
  { clip: "polygon(60% 85%, 70% 100%, 35% 100%, 30% 82%)", hover: { x: 0, y: 8 } },
  { clip: "polygon(30% 82%, 35% 100%, 0 100%, 0 82%)", hover: { x: -4, y: 6 } },
  { clip: "polygon(0 82%, 0 100%, 0 62%, 18% 55%)", hover: { x: -7, y: 3 } },
  { clip: "polygon(0 62%, 0 42%, 15% 38%, 18% 55%)", hover: { x: -7, y: 0 } },
  { clip: "polygon(0 42%, 0 20%, 18% 25%, 15% 38%)", hover: { x: -6, y: -2 } },
  { clip: "polygon(20% 15%, 50% 18%, 38% 35%, 22% 30%)", hover: { x: -1, y: -2 } },
  { clip: "polygon(50% 18%, 80% 22%, 65% 38%, 38% 35%)", hover: { x: 3, y: -1 } },
  { clip: "polygon(80% 22%, 85% 38%, 65% 38%)", hover: { x: 5, y: 0 } },
  { clip: "polygon(85% 38%, 88% 58%, 65% 55%, 65% 38%)", hover: { x: 4, y: 3 } },
  { clip: "polygon(88% 58%, 82% 80%, 60% 70%, 65% 55%)", hover: { x: 2, y: 5 } },
  { clip: "polygon(60% 85%, 60% 70%, 82% 80%)", hover: { x: 1, y: 6 } },
  { clip: "polygon(38% 35%, 65% 38%, 55% 55%, 45% 52%)", hover: { x: 1, y: 1 } },
  { clip: "polygon(45% 52%, 55% 55%, 65% 70%, 60% 85%, 30% 82%, 35% 62%)", hover: { x: -1, y: 3 } },
];
